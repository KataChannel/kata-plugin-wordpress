...
class KATA_Schema_Admin_UI {
    ...
    private static function get_schema_types() {
        return array(
            ...
            'breadcrumb' => __('Breadcrumb', 'kata-seo-manager'),
            'book' => __('Book', 'kata-seo-manager'),
            'movie' => __('Movie', 'kata-seo-manager'),
            'review' => __('Review', 'kata-seo-manager'),
            'newsarticle' => __('News Article', 'kata-seo-manager'),
            'blogposting' => __('Blog Posting', 'kata-seo-manager'),
