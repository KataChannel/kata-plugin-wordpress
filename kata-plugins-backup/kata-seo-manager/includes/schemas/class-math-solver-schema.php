<?php
/**
 * MathSolver Schema Class
 * 
 * Math solver schema for educational content
 * Subtypes: None
 * 
...
class KATA_MathSolver_Schema extends KATA_Base_Schema {
    
    protected $type = 'MathSolver';
    
    protected $required_fields = array('name');
    
    /**
     * Generate MathSolver schema
     * 
    ...
    public function get_example() {
        return array(
            ...
            'description' => 'This is an example MathSolver description',
            'url' => 'https://example.com/{strtolower(MathSolver)}',
    ...
    public function get_fields() {
        return array(
            'name' => array(
                ...
                'type' => 'text',
                'required' => true,
                'placeholder' => 'Enter MathSolver name'
            ),
            'description' => array(
