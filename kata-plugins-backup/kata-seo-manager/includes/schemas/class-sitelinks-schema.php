...
class KATA_Sitelinks_Schema extends KATA_Base_Schema {
    
    protected $type = 'Sitelinks';
    
    protected $required_fields = array('name');
    
    /**
     * Generate Sitelinks schema
     * 
    ...
    public function get_example() {
        return array(
            'name' => 'Example Sitelinks',
            'description' => 'This is an example Sitelinks description',
            'url' => 'https://example.com/{strtolower(Sitelinks)}',
    ...
    public function get_fields() {
        return array(
            'name' => array(
                ...
                'type' => 'text',
                'required' => true,
                'placeholder' => 'Enter Sitelinks name'
            ),
            'description' => array(
