...
class KATA_LocalBusiness_Schema extends KATA_Base_Schema {
    ...
    public function get_example() {
        return array(
            ...
            'description' => 'This is an example LocalBusiness description',
            'url' => 'https://example.com/{strtolower(LocalBusiness)}',
    ...
    public function get_fields() {
        return array(
            'name' => array(
                ...
                'type' => 'text',
                'required' => true,
                'placeholder' => 'Enter LocalBusiness name'
            ),
            'description' => array(
