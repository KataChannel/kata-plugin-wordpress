...
class KATA_EmployerRating_Schema extends KATA_Base_Schema {
    
    protected $type = 'EmployerRating';
    
    protected $required_fields = array('name');
    
    /**
     * Generate EmployerRating schema
     * 
    ...
    public function get_example() {
        return array(
            'name' => 'Example EmployerRating',
            'description' => 'This is an example EmployerRating description',
            'url' => 'https://example.com/{strtolower(EmployerRating)}',
    ...
    public function get_fields() {
        return array(
            'name' => array(
                ...
                'type' => 'text',
                'required' => true,
                'placeholder' => 'Enter EmployerRating name'
            ),
            'description' => array(
