...
class KATA_Speakable_Schema extends KATA_Base_Schema {
    
    protected $type = 'Speakable';
    ...
    public function get_example() {
        return array(
            'name' => 'Example Speakable',
            'description' => 'This is an example Speakable description',
            'url' => 'https://example.com/{strtolower(Speakable)}',
    ...
    public function get_fields() {
        return array(
            'name' => array(
                ...
                'type' => 'text',
                'required' => true,
                'placeholder' => 'Enter Speakable name'
            ),
            'description' => array(
