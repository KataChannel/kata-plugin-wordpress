<?php
/**
 * Wheel Management Admin Page - Senior UI/UX with Modal & Animations
 */
...
<div class="wrap kata-wheel-management-wrap">
    ...
    <div id="wheelsListContainer" class="kata-wheels-list-container">
    ...
    <div class="kata-modal-container">
        <div class="kata-modal-header">
            <h2 class="kata-modal-title">
                <span class="dashicons dashicons-edit"></span>
                <span id="modalTitle"><?php echo $current_wheel ? '✏️ Chỉnh Sửa Vòng Quay' : '➕ Tạo Vòng Quay Mới'; ?></span>
            </h2>
