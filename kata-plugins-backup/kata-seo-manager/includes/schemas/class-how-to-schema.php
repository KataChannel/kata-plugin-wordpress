 ...
 * HowTo Schema Class
 * 
 * How-to guide schema with step-by-step instructions
 * Subtypes: None
 * 
...
class KATA_HowTo_Schema extends KATA_Base_Schema {
    ...
    public function get_example() {
        return array(
            'name' => 'Example HowTo',
            'description' => 'This is an example HowTo description',
            'url' => 'https://example.com/{strtolower(HowTo)}',
