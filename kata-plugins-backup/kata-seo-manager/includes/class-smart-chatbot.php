...
class KATA_Smart_Chatbot {
    ...
    public function enqueue_frontend_assets() {
        ...
        wp_enqueue_style(
            'kata-smart-chatbot',
            KATA_SEO_MANAGER_PLUGIN_URL . 'assets/css/smart-chatbot.css',
            array(),
        ...
        wp_enqueue_script(
            'kata-smart-chatbot',
            KATA_SEO_MANAGER_PLUGIN_URL . 'assets/js/smart-chatbot.js',
            array('jquery'),
            KATA_SEO_MANAGER_VERSION,
            true
        );
    ...
    private function get_frontend_settings() {
        return array(
            ...
            'avatar' => get_option('kata_chatbot_avatar', KATA_SEO_MANAGER_PLUGIN_URL . 'assets/images/chatbot-avatar.png')
        );
    }
    ...
    public function render_chatbot_ui() {
        ...
        include KATA_SEO_MANAGER_PLUGIN_DIR . 'templates/chatbot-ui.php';
    }
...
Bạn muốn biết thêm về điều gì?',
    ...
    public function enqueue_admin_assets($hook) {
        ...
        wp_enqueue_style(
            'kata-chatbot-admin',
            KATA_SEO_MANAGER_PLUGIN_URL . 'assets/css/chatbot-admin.css',
            array(),
            KATA_SEO_MANAGER_VERSION
        );
        ...
        wp_enqueue_script(
            'kata-chatbot-admin',
            KATA_SEO_MANAGER_PLUGIN_URL . 'assets/js/chatbot-admin.js',
            array('jquery'),
            KATA_SEO_MANAGER_VERSION,
            true
        );
    ...
    public function render_admin_page() {
        include KATA_SEO_MANAGER_PLUGIN_DIR . 'admin/chatbot-settings.php';
    }
    ...
    public function render_logs_page() {
        include KATA_SEO_MANAGER_PLUGIN_DIR . 'admin/chatbot-logs.php';
    }
    ...
    public function render_leads_page() {
        include KATA_SEO_MANAGER_PLUGIN_DIR . 'admin/chatbot-leads.php';
    }
...
add_action('plugins_loaded', function() {
    KATA_Smart_Chatbot::get_instance();
});
