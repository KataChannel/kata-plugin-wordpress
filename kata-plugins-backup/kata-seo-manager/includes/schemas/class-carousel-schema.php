<?php
/**
 * Carousel Schema Class
 * 
 * Carousel schema for lists and galleries
 * Subtypes: None
 * 
...
class KATA_Carousel_Schema extends KATA_Base_Schema {
    ...
    public function get_example() {
        return array(
            ...
            'description' => 'This is an example Carousel description',
            'url' => 'https://example.com/{strtolower(Carousel)}',
