...
class KATA_ProfilePage_Schema extends KATA_Base_Schema {
    ...
    public function get_example() {
        return array(
            ...
            'description' => 'This is an example ProfilePage description',
            'url' => 'https://example.com/{strtolower(ProfilePage)}',
    ...
    public function get_fields() {
        return array(
            'name' => array(
                ...
                'type' => 'text',
                'required' => true,
                'placeholder' => 'Enter ProfilePage name'
            ),
            'description' => array(
