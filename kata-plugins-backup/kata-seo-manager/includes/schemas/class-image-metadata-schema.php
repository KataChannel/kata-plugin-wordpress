<?php
/**
 * ImageMetadata Schema Class
 * 
 * Image metadata schema for Google Images
 * Subtypes: None
 * 
...
class KATA_ImageMetadata_Schema extends KATA_Base_Schema {
    
    protected $type = 'ImageMetadata';
    
    protected $required_fields = array('name');
    
    /**
     * Generate ImageMetadata schema
     * 
    ...
    public function get_example() {
        return array(
            'name' => 'Example ImageMetadata',
            'description' => 'This is an example ImageMetadata description',
            'url' => 'https://example.com/{strtolower(ImageMetadata)}',
    ...
    public function get_fields() {
        return array(
            'name' => array(
                ...
                'type' => 'text',
                'required' => true,
                'placeholder' => 'Enter ImageMetadata name'
            ),
            'description' => array(
