...
class KATA_EduQA_Schema extends KATA_Base_Schema {
    
    protected $type = 'EduQA';
    
    protected $required_fields = array('name');
    
    /**
     * Generate EduQA schema
     * 
    ...
    public function get_example() {
        return array(
            'name' => 'Example EduQA',
            'description' => 'This is an example EduQA description',
            'url' => 'https://example.com/{strtolower(EduQA)}',
