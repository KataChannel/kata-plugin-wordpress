...
class KATA_SEO_Manager {
    ...
    /**
     * DEPRECATED: Enqueue admin scripts and styles
     * 
    ...
    public function enqueue_admin_scripts($hook) {
        ...
        // Asset loading is now handled by includes/class-asset-manager.php
    }
    */
    
    /**
     * DEPRECATED: Enqueue frontend scripts and styles
     * 
     * This method has been replaced by KATA_SEO_Asset_Manager
     * Kept for reference during transition period
     * 
    ...
    public function tinymce_admin_head() {
        ...
        if (isset($current_screen) && in_array($current_screen->base, array('post', 'page'))) {
            ...
            <style>
                ...
                /* 4. Ensure KATA buttons are visible */
                ...
                /* 5. Fix potential conflicts with custom positioning */
                .kata-seo-manager .mce-toolbar,
                .kata-seo-manager .mce-toolbar-grp {
                    position: relative !important;
                    top: auto !important;
                    left: auto !important;
                }
                
                /* ===== Fix TinyMCE Editor Area Padding Issue ===== */
                
                /* 6. Remove unwanted padding from editor area */
                ...
                /* 7. Fix iframe content area positioning */
                .mce-edit-area iframe {
                    padding-top: 0 !important;
                    margin-top: 0 !important;
                }
                
                /* 8. Ensure toolbar container has proper overflow */
                .mce-toolbar-grp,
                .mce-inline-toolbar-grp {
                    overflow: visible !important;
                }
                
                /* 9. Fix potential z-index stacking issues */
                .mce-tinymce.mce-container.mce-panel {
                    z-index: auto !important;
                }
                
                /* 10. Ensure toolbar buttons are not hidden */
